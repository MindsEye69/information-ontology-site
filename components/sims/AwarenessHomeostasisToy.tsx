...
function Tip(props: { text: string }) {
  return (
    <span className="group relative inline-flex cursor-pointer select-none items-center">
      <span className="ml-1 inline-flex h-4 w-4 select-none cursor-pointer items-center justify-center rounded-full border border-white/20 text-[10px] text-slate-200">
        i
      </span>
