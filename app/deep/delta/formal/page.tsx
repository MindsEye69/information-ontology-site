...
export const metadata: Metadata = {
  title: "Difference (Δ) — Formal layer (planned) | Informational Ontology",
  description:
    "Placeholder page for the formal/technical layer of Difference (Δ) in the Informational Ontology Deep Dive.",
};
    ...
    <main className="mx-auto max-w-5xl px-4 py-12 space-y-10">
      <section className="space-y-3">
        ...
        <h1 className="text-3xl font-bold tracking-tight sm:text-4xl">
          Difference (Δ) — Formal page (planned)
        </h1>
      ...
      <section className="space-y-4 rounded-2xl border border-slate-800 bg-slate-900/60 p-4">
        ...
        <div className="mt-2 flex flex-col gap-3 sm:flex-row">
          <Link href="/deep/delta" className="sm:w-1/2 w-full">
            <Button variant="outline" className="w-full border-slate-700">
              Back to Difference (Δ)
            </Button>
          </Link>
