...
export const metadata: Metadata = {
  title: "Relation (R) — Formal layer (planned) | Informational Ontology",
  description:
    "Placeholder page for the formal/technical layer of Relation (R) in the Informational Ontology Deep Dive.",
};
    ...
    <main className="mx-auto max-w-5xl px-4 py-12 space-y-10">
      <section className="space-y-3">
        ...
        <h1 className="text-3xl font-bold tracking-tight sm:text-4xl">
          Relation (R) — Formal page (planned)
        </h1>
      ...
      <section className="space-y-4 rounded-2xl border border-slate-800 bg-slate-900/60 p-4">
        ...
        <div className="mt-2 flex flex-col gap-3 sm:flex-row">
          <Link href="/deep/relation" className="sm:w-1/2 w-full">
