  ...
  return (
    <main className="mx-auto max-w-4xl px-4 py-12 space-y-10">
      ...
      <section className="space-y-4">
        ...
        <p className="text-lg text-neutral-700 dark:text-[#b8c6de] leading-relaxed">
        ...
        <p className="text-neutral-900 dark:text-[#b8c6de] font-semibold">
          What if time isn’t fundamental at all?
        </p>
      </section>

      <section className="space-y-4">
        <h2 className="text-xl font-semibold text-black dark:text-[#b8c6de]">
      ...
      <section className="space-y-4 rounded-2xl border border-neutral-200 dark:border-[#1a1e2a] bg-neutral-50 dark:bg-[#111828]/70 p-4">
        <h2 className="text-lg font-semibold text-black dark:text-[#b8c6de]">
          Constraint makes the difference
        </h2>
        <p className="text-sm text-neutral-700 dark:text-[#b8c6de] leading-relaxed">
